...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_dna_analyses_analysis_id'), 'dna_analyses', ['analysis_id'], unique=True)
    op.create_index(op.f('ix_dna_analyses_sample_id'), 'dna_analyses', ['sample_id'], unique=False)
    op.create_index(op.f('ix_dna_analyses_predicted_disease'), 'dna_analyses', ['predicted_disease'], unique=False)
    ...
    op.create_index(op.f('ix_evidence_cache_category'), 'evidence_cache', ['category'], unique=False)
